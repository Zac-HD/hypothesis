...
def _seq_pprinter_factory(start, end, basetype, arg_slices=None):
...
def _dict_pprinter_factory(arg_slices=None):
    ...
    inner.__name__ = f"_dict_pprinter_factory({arg_slices!r})"
    return inner
