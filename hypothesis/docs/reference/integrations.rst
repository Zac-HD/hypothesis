...
|ObservabilityConfig| enables coverage observations by default, but this can be
disabled if you notice performance problems.  On Python 3.12+, :mod:`sys.monitoring`
enables very fast collection so this should not be necessary.
